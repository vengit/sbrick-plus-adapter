...
uint8_t calculate_checksum(uint8_t *data, uint8_t l);

uint8_t verify_checksum(uint8_t *data, uint8_t l, uint8_t val);

uint8_t get_length(uint8_t val);

uint8_t get_type(uint8_t val);

uint8_t get_mode(uint8_t val);
